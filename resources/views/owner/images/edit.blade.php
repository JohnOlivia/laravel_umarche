                  ...
                  <form action="{{ route('owner.images.update'), ['image' => $image->id] }}" method="post">
                      ...
                      <div class="-m-2">
                        <div class="p-2 w-1/2 mx-auto">
                          <div class="relative">
                            <label for="title" class="leading-7 text-sm text-gray-600">画像タイトル
                            </label>
              ...
              <form id="delete_{{$image->id}}" action="{{ route('owner.images.destroy', ['image' => $image->id] ) }}" method="POST">
                ...
                <div class="p-2 w-full flex justify-around mt-7">
                  <a href="#" data-id="{{ $image->id }}"
                        ...
                        class=" text-white bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-green-500 rounded ">削除</a>
                </div>
            </form>
